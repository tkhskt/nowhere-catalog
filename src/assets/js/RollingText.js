import { TweenMax as TM, TimelineMax, Linear } from 'gsap/all';
...
export default class RollingText {
    ...
    hover() {
        this.$els.wrapper.querySelectorAll('.bg__nowhere-item').forEach((element) => {
            // element.classList.add('bg__nowehere-item--hover');
    ...
    leave() {
        this.$els.wrapper.querySelectorAll('.bg__nowhere-item').forEach((element) => {
            ...
            element.style.textShadow = '2px 2px 0 #434343, -2px 2px 0 #434343, 2px -2px 0 #434343, -2px -2px 0 #434343'
        });
    }

    hide() {
        this.$els.wrapper.removeChild(this.$els.clonedText);
        this.$els.wrapper.querySelectorAll('.bg__nowhere-item').forEach((element) => {
            // element.classList.remove('bg__nowehere-item--hover');
            element.style.color = '#1b1a1a'
            element.style.textShadow = '2px 2px 0 #434343, -2px 2px 0 #434343, 2px -2px 0 #434343, -2px -2px 0 #434343'
